...
チャリ走をもじって二人協力プレイにした体感型横スクロールアクションゲームです。

M5StickC Plus2 のセンサデータ（角速度・加速度）を Python サーバー経由でブラウザに送信し、Phaser 3 で動くゲームを操作します。
## 操作方法
横移動：一人がセンサ付きママチャリを漕ぐ

ジャンプ：もう一人がセンサを着けてジャンプする
